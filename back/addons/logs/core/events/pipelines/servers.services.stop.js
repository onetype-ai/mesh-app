...
onetype.PipelineOn('commit', 'servers:services:stop', async function(pipeline, result, properties)
{
	...
	const action  = 'servers.services.stop';
...
onetype.PipelineOn('rollback', 'servers:services:stop', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
