...
onetype.PipelineOn('commit', 'scripts:unpublish', async function(pipeline, result, properties)
{
	...
	const action  = 'scripts.unpublish';
...
onetype.PipelineOn('rollback', 'scripts:unpublish', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
