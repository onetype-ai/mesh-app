...
onetype.PipelineOn('commit', 'services:publish', async function(pipeline, result, properties)
{
...
onetype.PipelineOn('rollback', 'services:publish', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
