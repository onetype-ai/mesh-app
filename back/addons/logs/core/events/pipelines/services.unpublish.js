...
onetype.PipelineOn('commit', 'services:unpublish', async function(pipeline, result, properties)
{
	...
	const action  = 'services.unpublish';
...
onetype.PipelineOn('rollback', 'services:unpublish', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
