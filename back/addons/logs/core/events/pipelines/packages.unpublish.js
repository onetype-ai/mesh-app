...
onetype.PipelineOn('commit', 'packages:unpublish', async function(pipeline, result, properties)
{
	...
	const action  = 'packages.unpublish';
...
onetype.PipelineOn('rollback', 'packages:unpublish', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
