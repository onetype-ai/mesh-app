...
onetype.PipelineOn('commit', 'servers:packages:uninstall', async function(pipeline, result, properties)
{
	...
	const action  = 'servers.packages.uninstall';
...
onetype.PipelineOn('rollback', 'servers:packages:uninstall', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
