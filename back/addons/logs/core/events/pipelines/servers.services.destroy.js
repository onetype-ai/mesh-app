...
onetype.PipelineOn('commit', 'servers:services:destroy', async function(pipeline, result, properties)
{
	...
	const action  = 'servers.services.destroy';
...
onetype.PipelineOn('rollback', 'servers:services:destroy', async function(pipeline, result, properties, error)
{
	if(result.id.parent !== null)
	{
		return;
